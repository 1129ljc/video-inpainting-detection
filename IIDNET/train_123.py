...
names_file = {
    'train': '/ssd4/ljc/qushipei_unet_inpainting_detection/dataset/train_names1.txt',
    'test': '/ssd4/ljc/qushipei_unet_inpainting_detection/dataset/test_names.txt'
}

save_dir = {
    'image_10': '/ssd4/ljc/qushipei_unet_inpainting_detection/ckpt_iidnet/image_10_guonihe/',
    'image_25': '/ssd4/ljc/qushipei_unet_inpainting_detection/ckpt_iidnet/image_25_guonihe/',
    'image_33': '/ssd4/ljc/qushipei_unet_inpainting_detection/ckpt_iidnet/image_33_guonihe/'
}
...
class InpaintingForensics():
    def __init__(self, dataset_name):
        ...
        train_txt_path = names_file['train']
        train_txt_open = open(train_txt_path, mode='r', encoding='utf-8')
        train_lines = train_txt_open.readlines()
        train_names = []
        for line_index in range(len(train_lines)):
            line = train_lines[line_index].strip()
        ...
        print('val_num :', self.val_num)
        train_dataset = IID_Dataset(self.train_num, self.train_files, choice='train')
...
if __name__ == '__main__':
    ...
    model = InpaintingForensics(dataset_name)
    model.train()
